...
return [
    ...
    /** Extra USD kept on Mevon after auto-buy (usd_balance from /V1/balance — not usd_ledger_bal). */
    ...
    'fx_hourly_capture_enabled' => (bool) env('VIRTUAL_CARD_FX_HOURLY_CAPTURE_ENABLED', false),
    'fx_payment_capture_enabled' => (bool) env('VIRTUAL_CARD_FX_PAYMENT_CAPTURE_ENABLED', true),
    'fx_payment_capture_every' => max(1, (int) env('VIRTUAL_CARD_FX_PAYMENT_CAPTURE_EVERY', 50)),
