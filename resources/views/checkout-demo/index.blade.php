    ...
    <section class="py-14 sm:py-20">
        <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-midnight-deep mb-4 sm:mb-6">Checkout Demo</h1>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white card-marketing p-6 sm:p-8">
                <div class="mb-6 sm:mb-8">
                    ...
                    <p class="text-slate-600 text-sm sm:text-base">Fill in the details below to test our hosted checkout page</p>
                </div>
                ...
                <div class="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                        <div class="text-center">
                            ...
                            <h4 class="font-semibold text-midnight-deep mb-2">Enter Details</h4>
                            <p class="text-sm text-slate-600">Fill in the payment amount and service name</p>
                        </div>
                        <div class="text-center">
                            <div class="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                                <span class="text-primary font-bold text-xl">2</span>
                            </div>
                            <h4 class="font-semibold text-midnight-deep mb-2">View Checkout</h4>
                            <p class="text-sm text-slate-600">See our hosted checkout page with payment instructions</p>
                        </div>
                        <div class="text-center">
                            <div class="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                                <span class="text-primary font-bold text-xl">3</span>
                            </div>
                            <h4 class="font-semibold text-midnight-deep mb-2">Payment Details</h4>
                            <p class="text-sm text-slate-600">Get account details and payment instructions</p>
                        </div>
                    </div>
                </div>
