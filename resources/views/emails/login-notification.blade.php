...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-box { background: linear-gradient(135deg, #e8edff 0%, #d6deff 100%); border: 2px solid #3C50E0; border-radius: 12px; padding: 30px; margin: 30px 0; text-align: center; }
        .login-box .icon { width: 64px; height: 64px; background: #3C50E0; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; font-size: 32px; color: #ffffff; }
    ...
    <div style="padding: 20px;">
        <div class="email-container">
            <div class="email-header">
                ...
                <h1>{{ $appName }}</h1>
                <div class="subtitle">New Login Detected</div>
            </div>
            <div class="email-body">
                <div class="greeting">Hello {{ $business->name }}!</div>
                <div class="content-text">We detected a new login to your {{ $appName }} account. If this was you, you can safely ignore this email.</div>
                <div class="login-box">
                    <div class="icon">🔐</div>
                ...
                <div class="warning-box">
                    <div class="warning-text">
                        <strong>⚠️ Security Notice:</strong> If you didn't make this login, please change your password immediately and contact our support team. Your account security is our top priority.
                    </div>
                </div>
                <div class="content-text">If you made this login, you can safely ignore this email. For your security, we notify you of all login activity on your account.</div>
