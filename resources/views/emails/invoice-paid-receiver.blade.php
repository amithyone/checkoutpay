        ...
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <div class="success-box">
                    ...
                    <div style="color: #047857; font-size: 14px;">Your payment has been received and processed</div>
                </div>
                <div class="content-text">
                    Thank you for your payment! Your invoice has been successfully paid and confirmed.
                </div>
                ...
                <div class="content-text" style="margin-top: 25px; padding: 20px; background-color: #f0f4ff; border-radius: 8px;">
                    <strong>Receipt:</strong> This email serves as your payment receipt. Please keep it for your records.
                </div>
            </div>
