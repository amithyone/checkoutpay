...
<head>
    ...
    <title>Admin Login Detected - {{ $appName }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .email-header { background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 40px 30px; text-align: center; }
        ...
        .login-box { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 2px solid #f59e0b; border-radius: 12px; padding: 30px; margin: 30px 0; text-align: center; }
        .login-box .icon { width: 64px; height: 64px; background: #f59e0b; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; font-size: 32px; color: #ffffff; }
        .login-box .message { font-size: 18px; font-weight: 600; color: #1e293b; margin-bottom: 10px; }
        .info-grid { display: grid; gap: 15px; margin: 25px 0; }
        .info-item { background-color: #f7fafc; padding: 15px; border-radius: 8px; border-left: 4px solid #f59e0b; }
        ...
        .warning-box { background-color: #fef2f2; border-left: 4px solid #ef4444; padding: 15px 20px; margin: 25px 0; border-radius: 4px; }
        .warning-box .warning-text { font-size: 13px; color: #991b1b; line-height: 1.6; }
    ...
    <div style="padding: 20px;">
        <div class="email-container">
            <div class="email-header">
                ...
                <h1>{{ $appName }}</h1>
                <div class="subtitle">Admin Login Detected</div>
            </div>
            <div class="email-body">
                <div class="greeting">Hello {{ $business->name }}!</div>
                <div class="content-text">We detected that an administrator has logged in to your {{ $appName }} account. This is a security notification to keep you informed of all account access.</div>
                <div class="login-box">
                    <div class="icon">⚠️</div>
                    <div class="message">Admin Access Detected</div>
                    <div style="color: #475569; font-size: 14px; margin-top: 10px;">{{ now()->format('F d, Y \a\t g:i A') }}</div>
                </div>
                <div class="info-grid">
                    <div class="info-item">
                ...
                <div class="warning-box">
                    <div class="warning-text">
                        <strong>⚠️ Important Security Notice:</strong> An administrator has accessed your business account. If you didn't authorize this access or weren't expecting it, please contact our support team immediately. Your account security is our top priority.
                    </div>
                </div>
                <div class="content-text">If this was an authorized administrative action (such as support assistance), you can safely ignore this email. We notify you of all account access for your security.</div>
