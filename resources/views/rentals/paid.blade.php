...
<head>
    ...
    <title>Rental Paid - {{ $rental->rental_number }}</title>
...
<div class="max-w-lg mx-auto px-4 py-12 text-center">
    ...
    <p class="text-gray-600 mb-6">Your rental <strong>{{ $rental->rental_number }}</strong> has been paid and confirmed.</p>
    <p class="text-sm text-gray-500 mb-8">You can contact {{ $rental->business->name }}@if($rental->business_phone) at {{ $rental->business_phone }}@endif for pickup/collection details.</p>
