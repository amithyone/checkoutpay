...
<head>
    ...
    <title>Forgot Password - Payment Gateway</title></head>
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-sm border border-gray-200" action="{{ route('business.password.email') }}" method="POST">
                @csrf
                ...
                <div class="text-center space-y-2">
                    <a href="{{ route('business.login') }}" class="text-sm text-primary hover:underline block">
