...
<div class="space-y-4 lg:space-y-6 pb-20 lg:pb-0">
    ...
    <!-- Recent activity (above website breakdown so stats + activity read as one block) -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-start">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-4 lg:px-6 py-6 text-center text-xs text-gray-500">No transactions yet.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="lg:hidden divide-y divide-gray-200">
                ...
                @empty
                <div class="p-6 text-center text-xs text-gray-500">No transactions yet.</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 lg:px-6 py-3 text-xs sm:text-sm text-gray-900 break-words min-w-0">₦{{ number_format($withdrawal->amount, 2) }}</td>
                            <td class="px-4 lg:px-6 py-3">
                            ...
                            <td class="px-4 lg:px-6 py-3 text-xs sm:text-sm text-gray-500 whitespace-nowrap">{{ $withdrawal->created_at->format('M d, Y') }}</td>
                            <td class="px-4 lg:px-6 py-3">
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="px-4 lg:px-6 py-6 text-center text-xs text-gray-500">No withdrawals yet.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="lg:hidden divide-y divide-gray-200">
                ...
                @empty
                <div class="p-6 text-center text-xs text-gray-500">No withdrawals yet.</div>
                @endforelse
            </div>
        </div>
    </div>
