            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    @php
                        ...
                        $existingColor = old('background_color', $event->background_color ?? '#1e3a5f');
                        // If existing color is not in our predefined list, default to first option
                        $validColors = array_column($colorOptions, 'value');
                        $selectedColor = in_array($existingColor, $validColors) ? $existingColor : '#1e3a5f';
