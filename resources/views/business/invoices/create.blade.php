            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" name="allow_split_payment" id="allow_split_payment" value="1" {{ old('allow_split_payment') ? 'checked' : '' }}
                    ...
                    <div id="split-options" class="{{ old('allow_split_payment') ? '' : 'hidden' }} space-y-4 pl-0 border-t border-gray-200 pt-4 mt-4">
                        <div>
...
<script>
let itemIndex = 0;
const existingSplitPercentages = @json(old('split_percentages', []));
