...
@section('content')
<div class="max-w-5xl">
    <form action="{{ route('business.invoices.update', $invoice) }}" method="POST" id="invoiceForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div id="split-options" class="{{ old('allow_split_payment', $invoice->allow_split_payment) ? '' : 'hidden' }} space-y-4 pl-0 border-t border-gray-200 pt-4 mt-4">
                        ...
                        <div>
                            ...
                            <div id="split-percentages-container" class="flex flex-wrap gap-3">
                                <!-- Filled by JS -->
                            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('business.invoices.show', $invoice) }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
                        Cancel
                    </a>
...
function buildSplitPercentages() {
    ...
    container.innerHTML = '';
    const existing = Array.isArray(existingSplitPercentages) && existingSplitPercentages.length === n
        ? existingSplitPercentages
        : null;
