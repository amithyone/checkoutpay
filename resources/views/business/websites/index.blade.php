    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('business.websites.store') }}">
            ...
            <div class="space-y-3">
                ...
                <div>
                    <label for="webhook_url" class="block text-sm font-medium text-gray-700 mb-1">Webhook URL (Optional)</label>
                        ...
                        <div class="space-y-3">
                            ...
                            @if($website->is_approved)
                                <div class="border-t border-gray-200 pt-3">
                                    <form method="POST" action="{{ route('business.websites.update', $website) }}" class="flex gap-2">
                                        @csrf
                                        @method('PUT')
                                        <div class="flex-1">
                                        ...
                                        <div class="flex items-end">
                                            <button type="submit" class="px-4 py-2 text-sm bg-primary text-white rounded-lg hover:bg-primary/90">
