    ...
    <form id="lendingOfferForm" method="POST" action="{{ route('business.lending-offers.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <select name="repayment_type" id="repayment_type" class="mt-1 w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" onchange="toggleFrequencyField()">
                ...
                <option value="split" @selected(old('repayment_type','split')==='split')>Split installments</option>
            </select>
        </div>
        <div id="repayment_frequency_wrap" class="{{ old('repayment_type','split') === 'split' ? '' : 'hidden' }}">
            ...
            <select name="repayment_frequency" class="mt-1 w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
                ...
                <option value="weekly" @selected(old('repayment_frequency','weekly')==='weekly')>Weekly</option>
                <option value="monthly" @selected(old('repayment_frequency')==='monthly')>Monthly (every 30 days)</option>
            </select>
