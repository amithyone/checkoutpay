  ...
  "idempotency_key": "order-123-wallet-try-1"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6" id="consumer-wallet-api">
        ...
        <div class="space-y-4 text-sm text-gray-700">
            ...
            <p><strong>2c. Push token (mobile):</strong> <code class="text-xs bg-gray-100 px-1 rounded">POST …/wallet/push-token</code> JSON <code class="text-xs">{"token":"…","platform":"android"}</code> (Bearer) — stores FCM/APNs token for future notifications.</p>
            <p><strong>2d. Transfer email OTP (Tier 2):</strong> <code class="text-xs bg-gray-100 px-1 rounded">PATCH …/wallet/transfer-email-otp</code> JSON <code class="text-xs">{"transfer_email_otp_enabled":true}</code> — optional email 6-digit code for transfer confirmations. <code class="text-xs">GET …/wallet</code> exposes <code class="text-xs">transfer_email_otp_*</code> flags.</p>
