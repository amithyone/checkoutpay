...
@section('seo')
    @include('partials.seo-head', [
        'seoOverrides' => \App\Support\Seo::forPath('/wordpress-plugin'),
        'jsonLdExtra' => [
...
<section class="bg-gradient-to-br from-purple-50 via-white to-primary/5 py-12 sm:py-16 md:py-20">
        <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl">
                ...
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-midnight-deep mb-4">
                ...
                <p class="text-sm text-slate-500 mb-8">{{ \App\Support\CheckoutPayWordPressPlugin::versionLine() }}</p>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('support.index') }}" class="inline-flex items-center justify-center px-6 py-3 text-slate-700 hover:text-primary font-medium">
                        Support
                    </a>
                </div>
            </div>
    ...
    <section class="py-12 bg-white border-b border-gray-100">
        <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-midnight-deep mb-6">Features</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="p-5 rounded-xl border border-gray-200">
                    <i class="fas fa-university text-primary mb-3"></i>
                    <h3 class="font-semibold text-midnight-deep mb-2">Bank transfer checkout</h3>
                    <p class="text-sm text-slate-600">Virtual account details on the order thank-you page.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200">
                    <i class="fas fa-bolt text-primary mb-3"></i>
                    <h3 class="font-semibold text-midnight-deep mb-2">Webhooks &amp; status checks</h3>
                    <p class="text-sm text-slate-600">Orders move to paid when transfers are matched.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200">
                    <i class="fas fa-cubes text-primary mb-3"></i>
                    <h3 class="font-semibold text-midnight-deep mb-2">Blocks &amp; HPOS</h3>
                    <p class="text-sm text-slate-600">Works with Cart/Checkout blocks and WooCommerce HPOS.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200">
                    <i class="fas fa-flask text-primary mb-3"></i>
                    <h3 class="font-semibold text-midnight-deep mb-2">Test mode</h3>
                    <p class="text-sm text-slate-600">Test checkout before going live.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200">
                    <i class="fas fa-percent text-primary mb-3"></i>
                    <h3 class="font-semibold text-midnight-deep mb-2">Fee preview</h3>
                    <p class="text-sm text-slate-600">Refresh charges from CheckoutPay in gateway settings.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200">
                    <i class="fas fa-store text-primary mb-3"></i>
                    <h3 class="font-semibold text-midnight-deep mb-2">No storefront promos</h3>
                    <p class="text-sm text-slate-600">CheckoutPay links appear only in admin settings.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-surface-container-low">
        <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-midnight-deep mb-8">Installation</h2>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <h3 class="font-semibold text-midnight-deep mb-2">Install in WordPress</h3>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <h3 class="font-semibold text-midnight-deep mb-2">Connect CheckoutPay</h3>
                    <ol class="text-sm text-slate-600 space-y-2 list-decimal list-inside">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <h3 class="font-semibold text-midnight-deep mb-2">Test &amp; go live</h3>
                    <ol class="text-sm text-slate-600 space-y-2 list-decimal list-inside">
    ...
    <section class="py-12 bg-white">
        <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-midnight-deep mb-6">Requirements</h2>
