            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="url" name="website" id="website"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                        value="{{ old('website', $business->website) }}" placeholder="https://yourwebsite.com">
                ...
                <div id="card-payments" class="rounded-lg border border-gray-200 bg-gray-50 p-4 space-y-3 scroll-mt-24">
                    ...
                    <p class="text-xs text-gray-600">Allows <code class="bg-white px-1 rounded">payment_method: card</code> on payment-request (hosted checkout URL). Bank transfer remains the default. You can also toggle this on the business detail page.</p>
                    <label class="flex items-start gap-2 cursor-pointer">
                        <input type="checkbox" name="card_payments_enabled" value="1" {{ old('card_payments_enabled', $business->card_payments_enabled) ? 'checked' : '' }} class="mt-1">
                ...
                <div id="pay-at-shop" class="rounded-lg border border-gray-200 bg-gray-50 p-4 space-y-3 scroll-mt-24">
                    ...
                    <p class="text-xs text-gray-600">Allows the merchant to enable in-store CheckoutNow payments from their dashboard and receive POS credentials (terminal ID, signing key).</p>
                    <label class="flex items-start gap-2 cursor-pointer">
                        <input type="checkbox" name="broadcast_pay_at_shop_enabled" value="1" {{ old('broadcast_pay_at_shop_enabled', $business->broadcast_pay_at_shop_enabled) ? 'checked' : '' }} class="mt-1">
