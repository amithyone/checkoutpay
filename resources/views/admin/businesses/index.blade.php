        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @if(!empty($business->rubies_business_account_number))
                                <div class="text-sm font-mono text-gray-900">{{ $business->rubies_business_account_number }}</div>
                                @if(!empty($business->rubies_business_bank_name))
                                    <div class="text-xs text-gray-500 mt-1">{{ $business->rubies_business_bank_name }}</div>
                                @endif
                            @else
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">No businesses found</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
