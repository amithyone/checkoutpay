            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($items as $item)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="{{ route('admin.businesses.show', $item->business_id) }}" class="text-primary hover:underline">
                                {{ $item->business->name }}
                            </a>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="{{ route('admin.rental-items.edit', $item) }}" class="text-primary hover:underline mr-3">Edit</a>
                            <a href="{{ route('admin.rental-items.show', $item) }}" class="text-primary hover:underline">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">
                            No rental items found. <a href="{{ route('admin.rental-items.create') }}" class="text-primary hover:underline">Create one</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>
