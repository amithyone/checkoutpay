        ...
        <tbody class="divide-y divide-gray-200">
            @forelse($offers as $o)
                <tr>
                    ...
                    <td class="px-4 py-3">{{ number_format($o->interest_rate_percent, 2) }}% of principal · {{ $o->term_days }}d · {{ $o->repayment_type === 'lump' ? 'One-time' : 'Split ('.($o->repayment_frequency ?? 'weekly').')' }}</td>
