...
@section('title', 'Add Whitelisted Email')
@section('page-title', 'Add Whitelisted Email')

@section('content')
<div class="space-y-6">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.whitelisted-emails.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit" class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary/90 flex items-center">
                    <i class="fas fa-save mr-2"></i> Add Whitelisted Email
                </button>
            </div>
        </form>
    </div>
