...
@section('title', 'Create Bank Email Template')
@section('page-title', 'Create Bank Email Template')

@section('content')
<div class="max-w-4xl">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.bank-email-templates.store') }}" method="POST">
            @csrf
            <div class="space-y-6">
                <!-- Basic Info -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="bank_name" id="bank_name" required
                                ...
                                value="{{ old('bank_name') }}" placeholder="e.g., GTBank, Access Bank">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <input type="email" name="sender_email" id="sender_email"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                                value="{{ old('sender_email') }}" placeholder="e.g., alerts@gtbank.com">
                        ...
                        <div>
                            ...
                            <input type="text" name="sender_domain" id="sender_domain"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                                value="{{ old('sender_domain') }}" placeholder="e.g., @gtbank.com">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="amount_field_label" id="amount_field_label"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                                value="{{ old('amount_field_label') }}" placeholder="e.g., Amount, Sum, Value">
                        ...
                        <div>
                            ...
                            <input type="text" name="sender_name_field_label" id="sender_name_field_label"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                                value="{{ old('sender_name_field_label') }}" placeholder="e.g., Description, From, Sender">
                            <p class="text-xs text-gray-500 mt-1">Label in HTML table</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="account_number_field_label" id="account_number_field_label"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                                value="{{ old('account_number_field_label') }}" placeholder="e.g., Account Number">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="amount_pattern" id="amount_pattern"
                                ...
                                value="{{ old('amount_pattern') }}" placeholder="e.g., /(?:ngn|naira|₦)\s*([\d,]+\.?\d*)/i">
                        ...
                        <div>
                            ...
                            <input type="text" name="sender_name_pattern" id="sender_name_pattern"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary font-mono text-sm"
                                value="{{ old('sender_name_pattern') }}" placeholder="e.g., /from\s+([A-Z][A-Z\s]+?)\s+to/i">
                        ...
                        <div>
                            ...
                            <input type="text" name="account_number_pattern" id="account_number_pattern"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary font-mono text-sm"
                                value="{{ old('account_number_pattern') }}" placeholder="e.g., /account\s*number[\s:]+(\d+)/i">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="sample_html" id="sample_html" rows="8"
                                ...
                                placeholder="Paste sample HTML email here...">{{ old('sample_html') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="sample_text" id="sample_text" rows="6"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary font-mono text-xs"
                                placeholder="Paste sample text email here...">{{ old('sample_text') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="extraction_notes" id="extraction_notes" rows="4"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-primary focus:border-primary"
                        placeholder="Notes on how to extract data from this bank's emails...">{{ old('extraction_notes') }}</textarea>
