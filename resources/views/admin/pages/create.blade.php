        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="content" rows="15" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary">{{ old('content') }}</textarea>
                <p class="mt-1 text-xs text-gray-500">HTML content is supported</p>
            </div>
