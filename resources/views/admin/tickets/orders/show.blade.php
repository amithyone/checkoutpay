...
<div class="space-y-4 lg:space-y-6">
    <div class="flex justify-between items-center">
        <a href="{{ route('admin.tickets.orders.index') }}" class="text-primary hover:text-primary/80">
    ...
    @if($order->canBeRefunded())
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-red-500">
            <h2 class="text-xl font-bold mb-4 text-red-600">Refund Order</h2>
            <form action="{{ route('admin.tickets.orders.refund', $order) }}" method="POST">
                @csrf
                <div class="mb-4">
