...
<body class="bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-base sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto">
                    A comprehensive solution for businesses offering recurring membership programs, subscriptions, and access-based services with digital membership cards.
                </p>
    ...
    <section id="features" class="py-12 sm:py-16 md:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">Everything You Need for Membership Management</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Powerful membership features with digital cards and QR code verification</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Digital Membership Cards</h3>
                    <p class="text-gray-600">
                        Each member receives a professional PDF membership card with QR code for instant verification and access control.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-gray-600">
                        Quick and secure member verification with unique QR codes. Scan codes instantly to verify membership status.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-gray-600">
                        Set membership duration in days, weeks, months, or years. Perfect for any subscription model.
                    </p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-lg p-6 text-center shadow-sm border border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Monthly or annual gym memberships with access to equipment and facilities</p>
                </div>
                <div class="bg-white rounded-lg p-6 text-center shadow-sm border border-gray-200">
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm border border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Social clubs, professional associations, and community centers</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-primary to-primary/90">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">Ready to Start Your Membership Program?</h2>
            <p class="text-lg md:text-xl text-primary-100 mb-8">Create your first membership plan and start accepting members today!</p>
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                ...
                <a href="{{ route('memberships.index') }}" class="w-full sm:w-auto bg-transparent text-white border-2 border-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-white/10 font-medium text-base sm:text-lg transition-colors">
                    Browse Memberships
                </a>
            </div>
        </div>
