...
@section('title')
    @include('partials.marketing-head', ['seoPath' => '/products/memberships'])
@endsection
        ...
        <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div class="text-center p-6">
                    ...
                    <p class="text-slate-600">Track members, set limits, and manage capacity with ease.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-slate-600">Set memberships for days, weeks, months, or years.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-slate-600">Specify who your membership is for with our "Who is it for?" feature.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-slate-600">Highlight your best memberships to attract more customers.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-slate-600">Upload multiple images to showcase your facilities and services.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-slate-600">List all the features and benefits included in each membership.</p>
                </div>
            </div>
        </div>
    </section>
