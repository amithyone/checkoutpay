...
class Business extends Authenticatable implements CanResetPasswordContract
{
    ...
    protected $fillable = [
        ...
        'broadcast_pay_at_shop_permanent_settlement',
        'email_account_id',
        'is_active',
        'rental_auto_approve',
        'balance',
    ...
    protected $casts = [
        ...
        'overdraft_requested_amount' => 'decimal:2',
        ...
        'broadcast_pay_at_shop_permanent_settlement' => 'boolean',
