        ...
        foreach ($withdrawals as $withdrawal) {
            ...
            $rows[] = [
                'row' => [
                    ...
                    'counterparty_account_number' => trim((string) ($withdrawal->account_number ?? '')) ?: null,
                    ...
                    'meta' => array_filter([
                        ...
                        'bank_narration' => trim((string) ($withdrawal->bank_narration ?? '')) ?: null,
                        'payout_raw_response' => is_array($withdrawal->payout_raw_response) ? $withdrawal->payout_raw_response : null,
                    ], static fn ($v) => $v !== null && $v !== ''),
                ],
                'wallet_tx' => null,
                'sort_at' => $occurredAt?->getTimestamp() ?? 0,
