...
return new class extends Migration
{
    ...
    {
        // MySQL (esp. shared hosting with strict sql_mode) rejects NOT NULL
        // timestamp columns with no explicit default — use useCurrent().
        if (! Schema::hasTable('desktop_telemetry_events')) {
        ...
        if (! Schema::hasTable('desktop_policies')) {
        ...
        if (! Schema::hasTable('desktop_app_tokens')) {
