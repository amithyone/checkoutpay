# WordPress.org review — reply template (v1.4.3 / COPN)

**Before sending:** Verify **notify@check-outpay.com** on your [WordPress.org profile](https://profiles.wordpress.org/).

---

**Subject:** Re: Plugin slug — COPN Payment Gateway v1.4.3

Hello Plugins Team,

Thank you for reserving the slug **`copn-payment-gateway`**.

I have uploaded **version 1.4.3** with these updates:
