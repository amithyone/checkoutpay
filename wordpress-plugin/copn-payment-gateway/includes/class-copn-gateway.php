...
class Copn_Gateway extends WC_Payment_Gateway {
    ...
    public function thankyou_page($order_id) {
        ...
        if ($order->get_status() === 'processing' || $order->get_status() === 'completed') {
            ...
            echo '<p><button type="button" id="checkoutpay-check-status" class="button">' . esc_html__('Check Payment Status', 'copn-payment-gateway') . '</button></p>';
            ...
            echo '<button type="button" id="checkoutpay-update-amount-btn" class="button">' . esc_html__('Update amount & check status', 'copn-payment-gateway') . '</button></p>';
            echo '</div>';
