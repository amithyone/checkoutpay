...
= 1.4.0 =
* Rebrand to COPN (CheckoutPay Nigeria): plugin name **COPN Payment Gateway for Nigerian Businesses**, slug/text domain **copn-payment-gateway**.
...
= 1.4.0 =
Rebrand to COPN. Folder slug is now copn-payment-gateway; WooCommerce payment method ID remains checkoutpay for existing stores.
